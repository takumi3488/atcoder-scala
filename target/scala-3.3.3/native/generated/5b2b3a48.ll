...
@"_SM29scala.scalanative.posix.errnoG4type" = hidden global { ptr, i32, i32, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 -66, i32 -1, ptr @"_SM7__constG1-1" }
@"_SM28scala.scalanative.posix.pwd$G4type" = hidden global { { ptr, i32, i32, ptr }, i32, i32, ptr, [3 x ptr] } { { ptr, i32, i32, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 487, i32 -1, ptr @"_SM7__constG1-3" }, i32 8, i32 487, ptr @"_SM7__constG1-4", [3 x ptr] [ ptr @"_SM16java.lang.ObjectD8hashCodeiEO", ptr @"_SM16java.lang.ObjectD8toStringL16java.lang.StringEO", ptr @"_SM16java.lang.ObjectD6equalsL16java.lang.ObjectzEO" ] }
@"_SM31scala.scalanative.posix.pwdOps$G4type" = hidden global { { ptr, i32, i32, ptr }, i32, i32, ptr, [3 x ptr] } { { ptr, i32, i32, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 118, i32 -1, ptr @"_SM7__constG1-6" }, i32 8, i32 118, ptr @"_SM7__constG1-4", [3 x ptr] [ ptr @"_SM16java.lang.ObjectD8hashCodeiEO", ptr @"_SM16java.lang.ObjectD8toStringL16java.lang.StringEO", ptr @"_SM16java.lang.ObjectD6equalsL16java.lang.ObjectzEO" ] }
@"_SM31scala.scalanative.posix.pwdOps$G8instance" = hidden global { ptr } { ptr @"_SM31scala.scalanative.posix.pwdOps$G4type" }
@"_SM41scala.scalanative.posix.pwdOps$passwdOps$G4type" = hidden global { { ptr, i32, i32, ptr }, i32, i32, ptr, [3 x ptr] } { { ptr, i32, i32, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 204, i32 -1, ptr @"_SM7__constG1-8" }, i32 8, i32 204, ptr @"_SM7__constG1-4", [3 x ptr] [ ptr @"_SM16java.lang.ObjectD8hashCodeiEO", ptr @"_SM16java.lang.ObjectD8toStringL16java.lang.StringEO", ptr @"_SM16java.lang.ObjectD6equalsL16java.lang.ObjectzEO" ] }
...
@"_SM31scala.scalanative.posix.unistd$G4type" = hidden global { { ptr, i32, i32, ptr }, i32, i32, ptr, [3 x ptr] } { { ptr, i32, i32, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 569, i32 -1, ptr @"_SM7__constG2-10" }, i32 16, i32 569, ptr @"_SM7__constG2-11", [3 x ptr] [ ptr @"_SM16java.lang.ObjectD8hashCodeiEO", ptr @"_SM16java.lang.ObjectD8toStringL16java.lang.StringEO", ptr @"_SM16java.lang.ObjectD6equalsL16java.lang.ObjectzEO" ] }
...
_62000007.0:
  ...
  %_62000014 = icmp sle i32 171, %_62000013
  %_62000015 = icmp sle i32 %_62000013, 176
...
_62000017.0:
  ...
  %_62000023 = icmp sle i32 171, %_62000022
  %_62000024 = icmp sle i32 %_62000022, 176
...
_62000026.0:
  ...
  %_62000032 = icmp sle i32 171, %_62000031
  %_62000033 = icmp sle i32 %_62000031, 176
...
_62000035.0:
  ...
  %_62000041 = icmp sle i32 171, %_62000040
  %_62000042 = icmp sle i32 %_62000040, 176
...
_62000044.0:
  ...
  %_62000050 = icmp sle i32 171, %_62000049
  %_62000051 = icmp sle i32 %_62000049, 176
...
_62000053.0:
  ...
  %_62000059 = icmp sle i32 171, %_62000058
  %_62000060 = icmp sle i32 %_62000058, 176
...
_62000062.0:
  ...
  %_62000068 = icmp sle i32 171, %_62000067
  %_62000069 = icmp sle i32 %_62000067, 176
...
_62000071.0:
  ...
  %_62000077 = icmp sle i32 171, %_62000076
  %_62000078 = icmp sle i32 %_62000076, 176
...
_62000080.0:
  ...
  %_62000086 = icmp sle i32 171, %_62000085
  %_62000087 = icmp sle i32 %_62000085, 176
...
_62000089.0:
  ...
  %_62000095 = icmp sle i32 171, %_62000094
  %_62000096 = icmp sle i32 %_62000094, 176

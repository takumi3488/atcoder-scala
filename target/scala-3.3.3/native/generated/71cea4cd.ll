...
@"_SM21scala.deriving.MirrorG4type" = hidden global { ptr, i32, i32, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 -34, i32 -1, ptr @"_SM7__constG1-1" }
@"_SM29scala.deriving.Mirror$ProductG4type" = hidden global { ptr, i32, i32, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 -64, i32 -1, ptr @"_SM7__constG1-3" }
@"_SM31scala.deriving.Mirror$SingletonG4type" = hidden global { ptr, i32, i32, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 -77, i32 -1, ptr @"_SM7__constG1-5" }
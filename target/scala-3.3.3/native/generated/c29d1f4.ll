...
@"_SM26java.lang.impl.PosixThreadG4type" = hidden global { { ptr, i32, i32, ptr }, i32, i32, ptr, [3 x ptr] } { { ptr, i32, i32, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 56, i32 -1, ptr @"_SM7__constG1-1" }, i32 48, i32 56, ptr @"_SM7__constG1-2", [3 x ptr] [ ptr @"_SM16java.lang.ObjectD8hashCodeiEO", ptr @"_SM16java.lang.ObjectD8toStringL16java.lang.StringEO", ptr @"_SM16java.lang.ObjectD6equalsL16java.lang.ObjectzEO" ] }
@"_SM27java.lang.impl.PosixThread$G4type" = hidden global { { ptr, i32, i32, ptr }, i32, i32, ptr, [3 x ptr] } { { ptr, i32, i32, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 607, i32 -1, ptr @"_SM7__constG1-4" }, i32 16, i32 607, ptr @"_SM7__constG1-5", [3 x ptr] [ ptr @"_SM16java.lang.ObjectD8hashCodeiEO", ptr @"_SM16java.lang.ObjectD8toStringL16java.lang.StringEO", ptr @"_SM16java.lang.ObjectD6equalsL16java.lang.ObjectzEO" ] }
...
_1.0:
  %_4 = getelementptr ptr, ptr @"__modules", i32 202
...
_6000000.0:
  br label %_7000000.0
_7000000.0:
  %_7000003 = getelementptr { { ptr }, i1 }, { { ptr }, i1 }* %_5000001, i32 0, i32 1
  %_7000004 = zext i1 false to i8
  store i8 %_7000004, ptr%_7000003, align 1
  ret void
}